...
export const AdminLayoutRoutes: Routes = [
    {
        path: '',
        redirectTo: Utils.ROUTE_DASHBOARD,
        pathMatch: 'full'
      }, 
      {
        path: Utils.ROUTE_DASHBOARD,
        component: DashboardComponent,
      },
      {
        path: Utils.ROUTE_STAFF,
        component: StaffComponent,
      },
      {
        path: Utils.ROUTE_STUDENTS,
        component: StudentsComponent,
      },
      {
        path: Utils.ROUTE_BATCHES,
        component: BatchesComponent,
      },
      {
        path: Utils.ROUTE_SUBJECTS,
        component: SubjectsComponent,
      },
      {
        path: Utils.ROUTE_MEDIA,
